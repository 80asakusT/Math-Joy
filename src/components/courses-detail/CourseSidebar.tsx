  ...
  return (
    <div className="lg:w-1/4 block md:absolute right-[5%] top-[20%] h-full">
      <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        ...
        <div className="text-[#9364E7] font-semibold mb-1">
        ...
        <div className="flex items-center mb-6">
          <div className="text-2xl font-bold text-[#9364E7]">
            {(
        ...
        <button
          ...
          className="bg-[#9364E7] text-white w-full py-3 rounded-lg font-medium hover:bg-blue-700 transition cursor-pointer"
        >
          Thêm vào giỏ hàng
        </button>
        <button
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="text-[#9364E7] flex items-center gap-2 mt-4 font-medium"
          >
            {!showMoreCardProduct ? "Hiển thị thêm" : "Ẩn bớt"}
            {!showMoreCardProduct ? (
              <ArrowDown2 size="20" color="#9364E7" />
            ) : (
              <ArrowUp2 size="20" color="#9364E7" />
            )}
          </button>
        </div>
      </div>
