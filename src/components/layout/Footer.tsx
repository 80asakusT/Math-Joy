    ...
    <footer className="footer bg-white border-[1px] border-[#919EAB3D]">
      <div className="md:max-w-3xl max-w-sm lg:max-w-5xl xl:max-w-7xl mx-auto pt-16 pb-8 px-6 text-white">
        <div className="grid lg:grid-cols-6 gap-2 grid-cols-1 md:grid-cols-3 gap-y-6">
          <div className="col-span-1 md:col-span-3 lg:max-w-2/3">
            ...
            <div className="mt-8 text-base">
              MathJoy là nền tảng học tập trực tuyến hiện đại, mang đến trải nghiệm giáo dục linh hoạt và hiệu quả cho học sinh ở mọi lứa tuổi.
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 text-sm">
            <div className="text-xl font-semibold">MathJoy</div>
        ...
        <div className="lg:flex items-center justify-between">
          <div className="text-sm">Copyright © 2025 <span className="font-semibold">MathJoy</span>. All Rights Reserved</div>
