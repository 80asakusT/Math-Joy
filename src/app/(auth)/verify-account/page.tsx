    ...
    <div className="flex w-full flex-col md:flex-row-reverse flex-shrink-0">
      <div className="flex-1">
        <Image
          src={bannerSignIn}
          alt="banner"
          className="w-full h-screen hidden md:block p-6"
        />
      </div>
      <div className=" flex flex-col justify-center items-center w-full md:w-[40%] px-6 lg:px-8 flex-shrink-0">
        <div className="w-full xl:w-[50%] flex flex-col items-center">
          ...
          <Button
            ...
            className="font-semibold text-white bg-[#9364E7] hover:bg-[#9364E7] disabled:bg-gray-400 disabled:cursor-not-allowed rounded-xl w-full h-11 sm:h-12 text-sm sm:text-base transition-colors mb-6"
          >
            {isPending ? (
              <>
          ...
          <div className="text-center text-sm sm:text-base mb-6 sm:mb-8">
            ...
            <button
              ...
              className="text-[#9364E7] hover:underline cursor-pointer disabled:text-gray-400 disabled:cursor-not-allowed font-medium transition-colors"
          ...
          <button
            ...
            className="text-[#637381] text-sm sm:text-base hover:text-[#9364E7] cursor-pointer flex items-center justify-center gap-2 w-full transition-colors"
            disabled={isPending}
          >
            <span>←</span>
            Quay lại đăng nhập
