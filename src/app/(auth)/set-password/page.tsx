      ...
      <div className=" flex flex-col justify-center items-center w-full md:w-[40%] px-6 lg:px-8 flex-shrink-0">
        <div className="w-full xl:w-[50%] flex flex-col items-center">
          ...
          <Form {...form}>
            ...
            >
              ...
              <Button
                type="submit"
                disabled={isPending}
                className="font-semibold text-white bg-[#9364E7] hover:bg-[#9364E7] disabled:bg-gray-400 disabled:cursor-not-allowed rounded-xl w-full h-11 sm:h-12 text-sm sm:text-base transition-colors mt-6"
              >
                {isPending ? (
                  <>
          ...
          <button
            ...
            className="mt-6 sm:mt-8 text-sm sm:text-base text-[#637381] hover:text-[#9364E7] cursor-pointer flex items-center justify-center gap-2 w-full transition-colors"
            disabled={isPending}
          >
            <span>←</span>
            Quay lại đăng nhập
